...
int main(int argc, char *argv[]) {
    ...
    //in the following, we prepare enc_r_s needed in sbd_precom_rand
    ...
    //in the above, we prepare enc_r_s needed in sbd_precom_rand
    ...
    while (1) {
        ...
        if (command_to_receive == SBD) {
            ...
            for (i = 0; i < num_sbd; i = i + 1) {
                ...
                execute_sbd_precomputed_randomness_C_1(enc_a_bits,
                     enc_a,
                     pk, one_half,
