...
int main(int argc, char *argv[]) {
    ...
    sprintf(command_for_master, 
            "./scratch/P32_Master/master_smin_k %d %d > scratch/P32_Master/out_master_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P32_Master/err_master_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
    ...
    sprintf(command_for_C_1_s[0], 
            "./scratch/P33_C_1/C_1_smin_k mc18.cs.purdue.edu %d 0 %d %d %d %d > scratch/P33_C_1/out_C_1_0_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P33_C_1/err_C_1_0_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
    ...
    sprintf(command_for_C_1_s[1], 
            "./scratch/P33_C_1/C_1_smin_k mc18.cs.purdue.edu %d 1 %d %d %d %d > scratch/P33_C_1/out_C_1_1_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P33_C_1/err_C_1_1_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
    ...
    sprintf(command_for_C_1_s[2], 
            "./scratch/P33_C_1/C_1_smin_k mc18.cs.purdue.edu %d 2 %d %d %d %d > scratch/P33_C_1/out_C_1_2_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P33_C_1/err_C_1_2_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
    ...
    sprintf(command_for_C_1_s[3], 
            "./scratch/P33_C_1/C_1_smin_k mc18.cs.purdue.edu %d 3 %d %d %d %d > scratch/P33_C_1/out_C_1_3_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P33_C_1/err_C_1_3_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
    ...
    sprintf(command_for_C_1_s[4], 
            "./scratch/P33_C_1/C_1_smin_k mc18.cs.purdue.edu %d 4 %d %d %d %d > scratch/P33_C_1/out_C_1_4_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P33_C_1/err_C_1_4_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
    ...
    sprintf(command_for_C_1_s[5], 
            "./scratch/P33_C_1/C_1_smin_k mc18.cs.purdue.edu %d 5 %d %d %d %d > scratch/P33_C_1/out_C_1_5_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P33_C_1/err_C_1_5_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
    ...
    sprintf(command_for_C_1_s[6], 
            "./scratch/P33_C_1/C_1_smin_k mc18.cs.purdue.edu %d 6 %d %d %d %d > scratch/P33_C_1/out_C_1_6_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P33_C_1/err_C_1_6_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
    ...
    sprintf(command_for_C_1_s[7], 
            "./scratch/P33_C_1/C_1_smin_k mc18.cs.purdue.edu %d 7 %d %d %d %d > scratch/P33_C_1/out_C_1_7_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P33_C_1/err_C_1_7_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
    ...
    sprintf(command_for_C_2_s[0], 
            "./scratch/P34_C_2/C_2_smin_k mc01.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d %d %d > scratch/P34_C_2/out_C_2_0_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P34_C_2/err_C_2_0_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
            C_1_base_port + 0, num_smin_k, k, bit_length, num_smin_k, k, bit_length, num_smin_k, k, bit_length);
    sprintf(command_for_C_2_s[1], 
            "./scratch/P34_C_2/C_2_smin_k mc03.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d %d %d > scratch/P34_C_2/out_C_2_1_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P34_C_2/err_C_2_1_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
            C_1_base_port + 1, num_smin_k, k, bit_length, num_smin_k, k, bit_length, num_smin_k, k, bit_length);
    sprintf(command_for_C_2_s[2], 
            "./scratch/P34_C_2/C_2_smin_k mc05.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d %d %d > scratch/P34_C_2/out_C_2_2_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P34_C_2/err_C_2_2_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
            C_1_base_port + 2, num_smin_k, k, bit_length, num_smin_k, k, bit_length, num_smin_k, k, bit_length);
    sprintf(command_for_C_2_s[3], 
            "./scratch/P34_C_2/C_2_smin_k mc07.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d %d %d > scratch/P34_C_2/out_C_2_3_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P34_C_2/err_C_2_3_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
            C_1_base_port + 3, num_smin_k, k, bit_length, num_smin_k, k, bit_length, num_smin_k, k, bit_length);
    sprintf(command_for_C_2_s[4], 
            "./scratch/P34_C_2/C_2_smin_k mc09.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d %d %d > scratch/P34_C_2/out_C_2_4_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P34_C_2/err_C_2_4_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
            C_1_base_port + 4, num_smin_k, k, bit_length, num_smin_k, k, bit_length, num_smin_k, k, bit_length);
    sprintf(command_for_C_2_s[5], 
            "./scratch/P34_C_2/C_2_smin_k mc11.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d %d %d > scratch/P34_C_2/out_C_2_5_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P34_C_2/err_C_2_5_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
            C_1_base_port + 5, num_smin_k, k, bit_length, num_smin_k, k, bit_length, num_smin_k, k, bit_length);
    sprintf(command_for_C_2_s[6], 
            "./scratch/P34_C_2/C_2_smin_k mc13.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d %d %d > scratch/P34_C_2/out_C_2_6_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P34_C_2/err_C_2_6_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
            C_1_base_port + 6, num_smin_k, k, bit_length, num_smin_k, k, bit_length, num_smin_k, k, bit_length);
    sprintf(command_for_C_2_s[7], 
            "./scratch/P34_C_2/C_2_smin_k mc15.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d %d %d > scratch/P34_C_2/out_C_2_7_num_smin_k_%d_k_%d_bit_length_%d.txt 2> scratch/P34_C_2/err_C_2_7_num_smin_k_%d_k_%d_bit_length_%d.txt &", 
