...
int main(int argc, char *argv[]) {
    ...
    if (argc != 5) {
        fprintf(stderr, "usage: %s <primitive> <num_pairs_of_servers> <master_port> <C_1_base_port>\n", argv[0]);
        exit(0);
    }
    ...
    num_ssh_servers_for_C_1_s = atoi(argv[2]);//change here
    ...
    int C_1_base_port = atoi(argv[4]);

    char command_for_master[256];
    sprintf(command_for_master, 
            "./scratch/P16_Master/master_%s %d %d > scratch/P16_Master/out_master.txt 2> scratch/P16_Master/err_master.txt &", 
            argv[1], master_port, num_ssh_servers_for_C_1_s);

    char command_for_C_1_s[8][256];
    sprintf(command_for_C_1_s[0], 
            "./scratch/P17_C_1/C_1_%s mc18.cs.purdue.edu %d 0 %d > scratch/P17_C_1/out_C_1_0.txt 2> scratch/P17_C_1/err_C_1_0.txt &", 
            argv[1], master_port, C_1_base_port + 0);
    sprintf(command_for_C_1_s[1], 
            "./scratch/P17_C_1/C_1_%s mc18.cs.purdue.edu %d 1 %d > scratch/P17_C_1/out_C_1_1.txt 2> scratch/P17_C_1/err_C_1_1.txt &", 
            argv[1], master_port, C_1_base_port + 1);
    sprintf(command_for_C_1_s[2], 
            "./scratch/P17_C_1/C_1_%s mc18.cs.purdue.edu %d 2 %d > scratch/P17_C_1/out_C_1_2.txt 2> scratch/P17_C_1/err_C_1_2.txt &", 
            argv[1], master_port, C_1_base_port + 2);
    sprintf(command_for_C_1_s[3], 
            "./scratch/P17_C_1/C_1_%s mc18.cs.purdue.edu %d 3 %d > scratch/P17_C_1/out_C_1_3.txt 2> scratch/P17_C_1/err_C_1_3.txt &", 
            argv[1], master_port, C_1_base_port + 3);
    sprintf(command_for_C_1_s[4], 
            "./scratch/P17_C_1/C_1_%s mc18.cs.purdue.edu %d 4 %d > scratch/P17_C_1/out_C_1_4.txt 2> scratch/P17_C_1/err_C_1_4.txt &", 
            argv[1], master_port, C_1_base_port + 4);
    sprintf(command_for_C_1_s[5], 
            "./scratch/P17_C_1/C_1_%s mc18.cs.purdue.edu %d 5 %d > scratch/P17_C_1/out_C_1_5.txt 2> scratch/P17_C_1/err_C_1_5.txt &", 
            argv[1], master_port, C_1_base_port + 5);
    sprintf(command_for_C_1_s[6], 
            "./scratch/P17_C_1/C_1_%s mc18.cs.purdue.edu %d 6 %d > scratch/P17_C_1/out_C_1_6.txt 2> scratch/P17_C_1/err_C_1_6.txt &", 
            argv[1], master_port, C_1_base_port + 6);
    sprintf(command_for_C_1_s[7], 
            "./scratch/P17_C_1/C_1_%s mc18.cs.purdue.edu %d 7 %d > scratch/P17_C_1/out_C_1_7.txt 2> scratch/P17_C_1/err_C_1_7.txt &", 
            argv[1], master_port, C_1_base_port + 7);   


    char command_for_C_2_s[8][256];
    sprintf(command_for_C_2_s[0], 
            "./scratch/P18_C_2/C_2_%s mc01.cs.purdue.edu %d scratch/P18_C_2/factorization.txt > scratch/P18_C_2/out_C_2_0.txt 2> scratch/P18_C_2/err_C_2_0.txt &", 
            argv[1], C_1_base_port + 0);
    sprintf(command_for_C_2_s[1], 
            "./scratch/P18_C_2/C_2_%s mc03.cs.purdue.edu %d scratch/P18_C_2/factorization.txt > scratch/P18_C_2/out_C_2_1.txt 2> scratch/P18_C_2/err_C_2_1.txt &", 
            argv[1], C_1_base_port + 1);
    sprintf(command_for_C_2_s[2], 
            "./scratch/P18_C_2/C_2_%s mc05.cs.purdue.edu %d scratch/P18_C_2/factorization.txt > scratch/P18_C_2/out_C_2_2.txt 2> scratch/P18_C_2/err_C_2_2.txt &", 
            argv[1], C_1_base_port + 2);
    sprintf(command_for_C_2_s[3], 
            "./scratch/P18_C_2/C_2_%s mc07.cs.purdue.edu %d scratch/P18_C_2/factorization.txt > scratch/P18_C_2/out_C_2_3.txt 2> scratch/P18_C_2/err_C_2_3.txt &", 
            argv[1], C_1_base_port + 3);
    sprintf(command_for_C_2_s[4], 
            "./scratch/P18_C_2/C_2_%s mc09.cs.purdue.edu %d scratch/P18_C_2/factorization.txt > scratch/P18_C_2/out_C_2_4.txt 2> scratch/P18_C_2/err_C_2_4.txt &", 
            argv[1], C_1_base_port + 4);
    sprintf(command_for_C_2_s[5], 
            "./scratch/P18_C_2/C_2_%s mc11.cs.purdue.edu %d scratch/P18_C_2/factorization.txt > scratch/P18_C_2/out_C_2_5.txt 2> scratch/P18_C_2/err_C_2_5.txt &", 
            argv[1], C_1_base_port + 5);
    sprintf(command_for_C_2_s[6], 
            "./scratch/P18_C_2/C_2_%s mc13.cs.purdue.edu %d scratch/P18_C_2/factorization.txt > scratch/P18_C_2/out_C_2_6.txt 2> scratch/P18_C_2/err_C_2_6.txt &", 
            argv[1], C_1_base_port + 6);
    sprintf(command_for_C_2_s[7], 
            "./scratch/P18_C_2/C_2_%s mc15.cs.purdue.edu %d scratch/P18_C_2/factorization.txt > scratch/P18_C_2/out_C_2_7.txt 2> scratch/P18_C_2/err_C_2_7.txt &", 
            argv[1], C_1_base_port + 7);
