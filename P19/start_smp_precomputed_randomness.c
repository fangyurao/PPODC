...
int main(int argc, char *argv[]) {
    printf("start_smp_precomputed_randomness starts\n");

    if (argc != 5) {
        fprintf(stderr, "usage: %s <num_pairs_of_servers> <master_port> <C_1_base_port> <num_smp>\n", argv[0]);
        exit(0);
    }
    ...
    int num_smp = atoi(argv[4]);

    char command_for_master[512];
    sprintf(command_for_master, 
            "./scratch/P32_Master/master_smp %d %d > scratch/P32_Master/out_master_num_smp_%d_precomputed_randomness.txt 2> scratch/P32_Master/err_master_num_smp_%d_precomputed_randomness.txt &", 
            master_port, num_ssh_servers_for_C_1_s, num_smp, num_smp);

    char command_for_C_1_s[8][512];
    sprintf(command_for_C_1_s[0], 
            "./scratch/P33_C_1/C_1_smp_precomputed_randomness mc18.cs.purdue.edu %d 0 %d %d > scratch/P33_C_1/out_C_1_0_num_smp_%d_precomputed_randomness.txt 2> scratch/P33_C_1/err_C_1_0_num_smp_%d_precomputed_randomness.txt &", 
            master_port, C_1_base_port + 0, num_smp, num_smp, num_smp);
    sprintf(command_for_C_1_s[1], 
            "./scratch/P33_C_1/C_1_smp_precomputed_randomness mc18.cs.purdue.edu %d 1 %d %d > scratch/P33_C_1/out_C_1_1_num_smp_%d_precomputed_randomness.txt 2> scratch/P33_C_1/err_C_1_1_num_smp_%d_precomputed_randomness.txt &", 
            master_port, C_1_base_port + 1, num_smp, num_smp, num_smp);
    sprintf(command_for_C_1_s[2], 
            "./scratch/P33_C_1/C_1_smp_precomputed_randomness mc18.cs.purdue.edu %d 2 %d %d > scratch/P33_C_1/out_C_1_2_num_smp_%d_precomputed_randomness.txt 2> scratch/P33_C_1/err_C_1_2_num_smp_%d_precomputed_randomness.txt &", 
            master_port, C_1_base_port + 2, num_smp, num_smp, num_smp);
    sprintf(command_for_C_1_s[3], 
            "./scratch/P33_C_1/C_1_smp_precomputed_randomness mc18.cs.purdue.edu %d 3 %d %d > scratch/P33_C_1/out_C_1_3_num_smp_%d_precomputed_randomness.txt 2> scratch/P33_C_1/err_C_1_3_num_smp_%d_precomputed_randomness.txt &", 
            master_port, C_1_base_port + 3, num_smp, num_smp, num_smp);
    sprintf(command_for_C_1_s[4], 
            "./scratch/P33_C_1/C_1_smp_precomputed_randomness mc18.cs.purdue.edu %d 4 %d %d > scratch/P33_C_1/out_C_1_4_num_smp_%d_precomputed_randomness.txt 2> scratch/P33_C_1/err_C_1_4_num_smp_%d_precomputed_randomness.txt &", 
            master_port, C_1_base_port + 4, num_smp, num_smp, num_smp);
    sprintf(command_for_C_1_s[5], 
            "./scratch/P33_C_1/C_1_smp_precomputed_randomness mc18.cs.purdue.edu %d 5 %d %d > scratch/P33_C_1/out_C_1_5_num_smp_%d_precomputed_randomness.txt 2> scratch/P33_C_1/err_C_1_5_num_smp_%d_precomputed_randomness.txt &", 
            master_port, C_1_base_port + 5, num_smp, num_smp, num_smp);
    sprintf(command_for_C_1_s[6], 
            "./scratch/P33_C_1/C_1_smp_precomputed_randomness mc18.cs.purdue.edu %d 6 %d %d > scratch/P33_C_1/out_C_1_6_num_smp_%d_precomputed_randomness.txt 2> scratch/P33_C_1/err_C_1_6_num_smp_%d_precomputed_randomness.txt &", 
            master_port, C_1_base_port + 6, num_smp, num_smp, num_smp);
    sprintf(command_for_C_1_s[7], 
            "./scratch/P33_C_1/C_1_smp_precomputed_randomness mc18.cs.purdue.edu %d 7 %d %d > scratch/P33_C_1/out_C_1_7_num_smp_%d_precomputed_randomness.txt 2> scratch/P33_C_1/err_C_1_7_num_smp_%d_precomputed_randomness.txt &", 
            master_port, C_1_base_port + 7, num_smp, num_smp, num_smp);   


    char command_for_C_2_s[8][512];
    sprintf(command_for_C_2_s[0], 
            "./scratch/P34_C_2/C_2_smp_precomputed_randomness mc01.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d > scratch/P34_C_2/out_C_2_0_num_smp_%d_precomputed_randomness.txt 2> scratch/P34_C_2/err_C_2_0_num_smp_%d_precomputed_randomness.txt &", 
            C_1_base_port + 0, num_smp, num_smp, num_smp);
    sprintf(command_for_C_2_s[1], 
            "./scratch/P34_C_2/C_2_smp_precomputed_randomness mc03.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d > scratch/P34_C_2/out_C_2_1_num_smp_%d_precomputed_randomness.txt 2> scratch/P34_C_2/err_C_2_1_num_smp_%d_precomputed_randomness.txt &", 
            C_1_base_port + 1, num_smp, num_smp, num_smp);
    sprintf(command_for_C_2_s[2], 
            "./scratch/P34_C_2/C_2_smp_precomputed_randomness mc05.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d > scratch/P34_C_2/out_C_2_2_num_smp_%d_precomputed_randomness.txt 2> scratch/P34_C_2/err_C_2_2_num_smp_%d_precomputed_randomness.txt &", 
            C_1_base_port + 2, num_smp, num_smp, num_smp);
    sprintf(command_for_C_2_s[3], 
            "./scratch/P34_C_2/C_2_smp_precomputed_randomness mc07.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d > scratch/P34_C_2/out_C_2_3_num_smp_%d_precomputed_randomness.txt 2> scratch/P34_C_2/err_C_2_3_num_smp_%d_precomputed_randomness.txt &", 
            C_1_base_port + 3, num_smp, num_smp, num_smp);
    sprintf(command_for_C_2_s[4], 
            "./scratch/P34_C_2/C_2_smp_precomputed_randomness mc09.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d > scratch/P34_C_2/out_C_2_4_num_smp_%d_precomputed_randomness.txt 2> scratch/P34_C_2/err_C_2_4_num_smp_%d_precomputed_randomness.txt &", 
            C_1_base_port + 4, num_smp, num_smp, num_smp);
    sprintf(command_for_C_2_s[5], 
            "./scratch/P34_C_2/C_2_smp_precomputed_randomness mc11.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d > scratch/P34_C_2/out_C_2_5_num_smp_%d_precomputed_randomness.txt 2> scratch/P34_C_2/err_C_2_5_num_smp_%d_precomputed_randomness.txt &", 
            C_1_base_port + 5, num_smp, num_smp, num_smp);
    sprintf(command_for_C_2_s[6], 
            "./scratch/P34_C_2/C_2_smp_precomputed_randomness mc13.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d > scratch/P34_C_2/out_C_2_6_num_smp_%d_precomputed_randomness.txt 2> scratch/P34_C_2/err_C_2_6_num_smp_%d_precomputed_randomness.txt &", 
            C_1_base_port + 6, num_smp, num_smp, num_smp);
    sprintf(command_for_C_2_s[7], 
            "./scratch/P34_C_2/C_2_smp_precomputed_randomness mc15.cs.purdue.edu %d scratch/P34_C_2/factorization.txt %d > scratch/P34_C_2/out_C_2_7_num_smp_%d_precomputed_randomness.txt 2> scratch/P34_C_2/err_C_2_7_num_smp_%d_precomputed_randomness.txt &", 
            C_1_base_port + 7, num_smp, num_smp, num_smp);
